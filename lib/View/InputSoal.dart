...
class InputSoal extends StatefulWidget {
  @override
  _InputSoalState createState() => _InputSoalState();
}

class _InputSoalState extends State<InputSoal> {
  TextStyle style = TextStyle(fontFamily: 'Montserrat', fontSize: 20.0);
  final _judulMateri = TextEditingController();
  final _pilihan1 = TextEditingController();
